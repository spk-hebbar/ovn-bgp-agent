...
from ovn_bgp_agent.drivers.openstack.utils.qpb import qpb_pb2 as qpb_dot_qpb__pb2
...
_NEXTHOP.fields_by_name['if_id'].message_type = qpb_dot_qpb__pb2._IFIDENTIFIER
_NEXTHOP.fields_by_name['address'].message_type = qpb_dot_qpb__pb2._L3ADDRESS
_ROUTEKEY.fields_by_name['prefix'].message_type = qpb_dot_qpb__pb2._L3PREFIX
_DELETEROUTE.fields_by_name['address_family'].enum_type = qpb_dot_qpb__pb2._ADDRESSFAMILY
_DELETEROUTE.fields_by_name['sub_address_family'].enum_type = qpb_dot_qpb__pb2._SUBADDRESSFAMILY
_DELETEROUTE.fields_by_name['key'].message_type = _ROUTEKEY
_ADDROUTE.fields_by_name['address_family'].enum_type = qpb_dot_qpb__pb2._ADDRESSFAMILY
_ADDROUTE.fields_by_name['sub_address_family'].enum_type = qpb_dot_qpb__pb2._SUBADDRESSFAMILY
_ADDROUTE.fields_by_name['key'].message_type = _ROUTEKEY
_ADDROUTE.fields_by_name['route_type'].enum_type = _ROUTETYPE
_ADDROUTE.fields_by_name['protocol'].enum_type = qpb_dot_qpb__pb2._PROTOCOL
